...
@section('title')
    Laporan Pengembalian Smart Library
@endsection
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Laporan Pengembalian Perpustakaan</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Laporan Pengembalian Smart Library</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div class="row">
                    <div class="col-3">
                      <form role="form" action="{{ route('laporan-pengembalian-bulan') }}" method="POST" class="mb-5">
                        @csrf
    ...
    <script>
      var datatable = $('#crudTable').DataTable({
        ...
        buttons : [
                    ...
                    {extend:'csv'},
                    {extend: 'pdf', title:'Laporan Pengembalian Smart Library Bulan {{ $monthNameSelected }}'},
                    {extend: 'excel', title: 'Laporan Pengembalian Smart Library Bulan {{ $monthNameSelected }}'},
                    {extend:'print',title: 'Laporan Pengembalian Smart Library Bulan {{ $monthNameSelected }}'},
        ],
        ajax: {
          url: '{!! url()->current() !!}',
        },
        columns: [
          ...
          { data: 'status', name: 'status', width: '18%' },
          { data: 'denda', name: 'denda',  width: '18%' },
        ]
      })
    </script>
@endpush